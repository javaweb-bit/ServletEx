...
public class CookieTestServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//	Cookie 생성
		Cookie cookie = new Cookie("example", value);	//	"example"키에 value 저장
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if ("delete".equals(action)) {
			...
			if (cookies != null) {	//	쿠키가 있다!
				for (Cookie cookie: cookies) {	//	세팅했던 example cookie를 찾아봅니다.
					if (cookie.getName().equals("example")) {
						//	쿠키 값 받아오기
		...
		RequestDispatcher rd =
				req.getRequestDispatcher("/WEB-INF/views/cookies/cookie_form.jsp");
		rd.forward(req, resp);
	}
